...
<table>
    <thead>
        <tr>
            <th>OS</th>
            <th>Default Soft Limit (<code>ulimit -n</code>)</th>
            <th>Hard Limit</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Linux</td>
            <td>1024</td>
            <td>65,535+ (with tuning)</td>
        </tr>
        <tr>
            <td>macOS</td>
            <td>256–1024</td>
            <td>16,384 (modifiable)</td>
        </tr>
        <tr>
            <td>Windows</td>
            <td colspan="2">Uses <code>SOCKET</code> handles, different limits</td>
        </tr>
    </tbody>
</table>
