...
const Blog = () => {
  ...
  return <div className={styles.container}>To Be Released... :)</div>;
  //   return (
  //     <div className={styles.container}>
  //       <div>
  //         <Link className={styles.blogLinks} to="/blog/going-to-mars">
  //           Going to Mars is a bad idea.
  //         </Link>
  //       </div>
  //       <div>
  //         <Link className={styles.blogLinks} to="/blog/another-blog-post">
  //           Another blog post
  //         </Link>
  //       </div>
  //     </div>
