...
const Home = () => {
    ...
    return <div className={styles.container}>
        <p>Hey, I'm John :)</p>
        <p>I'm a <em style={{ padding: 10, textDecoration: "underline" }}>senior full stack engineer</em> focused mainly on JS/TS stacks <SiTypescript size={"30px"} style={{ marginLeft: 10 }} /></p>
